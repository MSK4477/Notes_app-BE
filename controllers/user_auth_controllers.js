import {passwordHasher, setCookies, sendEmail } from "../Utils/index.js";
import asyncHandler from "express-async-handler"
import User from "../Database/Model/user_schema.js";
import jwt from "jsonwebtoken"
import bcrypt from "bcryptjs"

const tokenGenarator = async (email) =>  {
...
export const register  = asyncHandler(async(req, res) =>  {
    ...
    try {
      ...
      const newUser =  await User.create( { 
        ...
        res.status(200).json({message:"User Created Succesfully", newUser, code:1})
...
export const verify = asyncHandler(async (req, res) => {
  ...
  console.log(hashed)
      ...
      res.status(200).json({message:  "Password Changed Succesfully", code:1})
